...
export function LoginForm() {
  ...
  return (
    <Card className="border border-border/80 bg-card/90 shadow-[var(--shadow-strong)]">
      <CardHeader className="space-y-2 text-center">
        <CardTitle className="text-2xl font-black text-primary-color">Masuk ke Dashboard</CardTitle>
