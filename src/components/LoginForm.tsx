...
import { ArrowRight, Eye, EyeOff, Loader2, LockKeyhole, Sparkles, UserRound } from "lucide-react";
  ...
  return (
    <Card className="border border-custom/80 bg-white/80 shadow-xl backdrop-blur dark:bg-card">
      <CardHeader className="space-y-1 text-center">
        <CardTitle className="text-2xl font-bold text-primary-color">Login</CardTitle>
        <p className="text-sm text-secondary-color">
          Masuk dengan akun valid untuk mengakses dashboard layanan.
        </p>
      </CardHeader>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button
              ...
              disabled={isLoading}
            >
              {isLoading ? <Loader2 className="h-4 w-4 animate-spin" /> : "Masuk ke Dashboard"}
            </Button>
          </form>
        </Form>
      </CardContent>
